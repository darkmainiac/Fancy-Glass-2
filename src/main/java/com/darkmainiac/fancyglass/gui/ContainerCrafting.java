...
public class ContainerCrafting extends Container {
	...
	public ContainerCrafting(InventoryPlayer inventoryPlayer, World world, int x, int y, int z)
	{
	 ...
	 public boolean canInteractWith(EntityPlayer par1EntityPlayer)
	    {
	        return this.worldObj.getBlockId(this.posX, this.posY, this.posZ) != BlockIds.GLASS_CRAFTING_TABLE ? false : par1EntityPlayer.getDistanceSq((double)this.posX + 0.5D, (double)this.posY + 0.5D, (double)this.posZ + 0.5D) <= 64.0D;
	    }
